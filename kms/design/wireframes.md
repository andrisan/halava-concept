...
|--------|----------|--------|
| Home / Explore | P0 | Pending |
| Search Results | P0 | Pending |
| Place Page | P0 | Pending |
| Merchant Shopfront | P0 | Pending |
| Product Detail | P0 | Pending |
| Cart | P0 | Pending |
...
| Screen | Priority | Status |
|--------|----------|--------|
| Dashboard Overview | P0 | Pending |
| Capabilities | P0 | Pending |
| Products & Menu | P0 | Pending |
| Orders & Transactions | P0 | Pending |
...
- [ ] Component callouts linked to [[design-system]]
- [ ] Edge case states (empty, error, loading)

---

#halava #design #wireframes
