...
| **Early Adopter Program** | Phase 1 merchants with 50% discount + feature development partnership |
...
| **Honor-based fees** | Phase 1 fee collection via monthly invoicing (before payment integration) |
...
| Phase | Description |
|-------|-------------|
| **Phase 1** | MVP — Off-platform settlement, honor-based monthly invoicing |
| **Phase 2** | Payment provider integration (Stripe Connect / PAY.JP) |
| **Phase 3** | Direct 資金移動業 license (3-5+ years) |
